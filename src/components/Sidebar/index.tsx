          ...
          <div className='text-black'>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="/"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-black duration-300 ease-in-out hover:bg-[#E54F26] dark:hover:bg-meta-4 hover:text-white ${
                          (pathname === '/' ||
                            pathname.includes('dashboard')) &&
                          'bg-[#E54F26] text-white dark:bg-meta-4'
                        }`}
                        // onClick={(e) => {
                        //   e.preventDefault();
                        //   sidebarExpanded
              ...
              <li>
                <NavLink
                  to="/home"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-black duration-300 ease-in-out hover:bg-[#E54F26] dark:hover:bg-meta-4 hover:text-white ${
              ...
              <li>
                <NavLink
                  to="/about"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-black duration-300 ease-in-out hover:bg-[#E54F26] dark:hover:bg-meta-4 hover:text-white ${
                    pathname.includes('about') && 'bg-[#E54F26] text-white dark:bg-meta-4'
                  }`}
                >
                  <svg
                    className="fill-current"
              ...
              <li>
                <NavLink
                  to="/work"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-black duration-300 ease-in-out hover:bg-[#E54F26] dark:hover:bg-meta-4 hover:text-white ${
                    pathname.includes('work') && 'bg-[#E54F26] text-white dark:bg-meta-4'
                  }`}
                >
                  <svg
                    className="fill-current"
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
               <NavLink
                  to="/site_setting"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-black duration-300 ease-in-out hover:bg-[#E54F26] dark:hover:bg-meta-4 hover:text-white ${
                    pathname.includes('site_setting') &&
                    'bg-[#E54F26] text-white dark:bg-meta-4'
                  }`}
                >
                  <svg

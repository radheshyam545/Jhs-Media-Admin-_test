...
//               </div>
//             <div  className='mb-5'>
//                 <label className="block text-gray-700 font-medium mb-2 text-[14px]">Timing</label>
//                 <input
//                   type="text"
//                   // value={sectionData[selectedSection]?.[field.key] || ''}
//                   // onChange={(e) => handleInputChange(selectedSection, field.key, e.target.value)}
...
//                 </div>
//                 <div className='mt-4'>
//                   <label className="block text-gray-700 font-medium mb-2">Card information</label>
//                   <input
//                     type="text"
//                     value={card.title}
//                     onChange={(e) => handleCardInputChange(index, 'title', e.target.value)}
